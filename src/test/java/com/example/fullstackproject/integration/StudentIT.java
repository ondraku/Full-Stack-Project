package com.example.fullstackproject.integration;

import com.example.fullstackproject.student.Gender;
import com.example.fullstackproject.student.Student;
import com.example.fullstackproject.student.StudentRepository;
...
public class StudentIT {
    ...
    void ShouldRegisterNewStudent() throws Exception {
        ...
        Student student = new Student(
                name,
                String.format("%s@dummy.com", StringUtils.trimAllWhitespace(name.trim().toLowerCase())),
                Gender.MALE
        );
    ...
    void canDeleteStudent() throws Exception {
        ...
        String email = String.format("%s@dummy.com",
